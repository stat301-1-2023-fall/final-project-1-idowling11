## Exploration 1: What are Driving Factors Behind Career Success, 
## and What Does Draft Spot Have To Do With That?
...
# AV Distribution: Could be biased due to non-retired players whose careers aren't finished.
...
nfl_draft_prospect_data_outcomes_1985_to_2015 |>
  ...
  labs(title = "Distribution of Career AV by Pick Number, Retired First-Rounders: 1985-2015",  
       x = "Overall Pick Number", y = "Career Approximate Value (AV)")
...
nfl_draft_prospect_data_outcomes_1985_to_2015 |>
  ...
  labs(title = "Distribution of Career AV by Pick Number, Retired Second-Rounders: 1985-2015",  
       x = "Overall Pick Number", y = "Career Approximate Value (AV)")
