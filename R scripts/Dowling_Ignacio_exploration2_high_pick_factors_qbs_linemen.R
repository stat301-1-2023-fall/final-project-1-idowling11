# Exploration 2: With First-Round Value Looking High, 
## what Factors Potentially Indicate Getting Picked Highly in the 21st century for
## Different Positions?
...
qb_data_to_2004 |>
  ...
  labs(title = "Distribution of College Estimated Points Added: Quarterback Prospects 
       from 2004-2021", x = "Estimated Points Added (EPA)")
...
kable(data.frame(top_qb_epas), col.names = names, 
      caption = "Top 25 College Quarterback Seasons by Estimated Points Added Since 2004")

# Examining QBR for QB prospects
qb_data_to_2004 |>
  ggplot(aes(x = total_qbr)) +
  geom_histogram(color = "white", binwidth = 5) +
  labs(title = "Distribution of College Quarterback Rating: Prospects from 2004-2021", 
       x = "Quarterback Rating (QBR)")
...
kable(data.frame(top_qbrs), col.names = names, 
      caption = "Top 25 College Quarterback Ratings Since 2004")
...
kable(data.frame(top_college_qbs), col.names = names, 
      caption = "Top College Quarterbacks by EPA and QBR since 2004")
...
nfl_draft_prospect_data_combined_1985_to_2021 |>
  ...
  geom_point(size = 4) +
  labs(title = "QBs in Top 25 of College QBR and EPA Since 2004: Draft Pick vs. ESPN Grade", 
       subtitle = "Note that the highest-ranked, highest-picked QBs are near 
...
nfl_draft_prospect_data_combined_1985_to_2021 |>
  ...
  ggplot(aes(x = overall, y = grade, color = player_name)) +
  geom_point(size = 4) +
  labs(title = "QBs with Top 25 College EPA Since 2004: Draft Pick vs. ESPN Grade", 
       subtitle = "This does not include the nine players also ranked in Top 25 for 
                    College QBR since 2004.", 
       x = "Overall Pick", 
       y = "ESPN Draft Grade", 
       color = "Player Name", 
       caption = "All other players in the top 25 not listed here or 
                  in subtitle were not drafted.")
...
nfl_draft_prospect_data_combined_1985_to_2021 |>
  ...
  labs(title = "QBs with Top 25 College QBR Seasons Since 2004: Draft Pick vs. ESPN Grade", 
       ...
       y = "ESPN Draft Grade", 
       color = "Player Name", 
       caption = "All other players in the top 25 not 
                  listed here or in subtitle were not drafted.")
...
nfl_draft_prospect_data_combined_1985_to_2021 |>
  ...
  facet_wrap(~pos_abbr, labeller = labeller(pos_abbr =
                                              c("DE" = "Defensive Ends", 
                                                ...
                                                "OG" = "Offensive Guards"))) +
  labs(title = "Weight and Height vs. Draft Pick: NFL-Drafted Linemen", 
...
nfl_prospects_by_era <- nfl_draft_prospect_data_combined_1985_to_2021 |>
  ...
  mutate(
    draft_era = fct_collapse(factored_draft_year,
                             ...
                             "1990s" = c("1990", "1991", "1992", "1993", "1994", 
                                         "1995", "1997", "1998",
                                         "1999"),
                             "2000s" = c("2000", "2001", "2002", "2003", "2004", 
                                         "2005", "2006", "2007", "2008",
                                         "2009"),
                             "2010s" = c("2010", "2011", "2012", "2013", "2014", 
                                         "2015", "2016", "2017", "2018",
                                         "2019"),
                             "2020s" = c("2020", "2021"))) 
...
nfl_prospects_by_era |>
  ...
  labs(title = "Weight and Height vs. Draft Pick: NFL-Drafted Offensive Tackles", 
       x = "Overall Draft Pick", 
       y = "Weight (lbs)", 
       color = "Height (inches)")
...
nfl_prospects_by_era |>
  ...
  geom_smooth(method = "lm", color = "red") +
  facet_wrap(~draft_era) +
  labs(title = "Weight and Height vs. Draft Pick: NFL-Drafted Offensive Guards", 
       x = "Overall Draft Pick", y = "Weight (lbs)", color = "Height (inches)")
...
nfl_prospects_by_era |>
  ...
  geom_smooth(method = "lm", color = "red") +
  facet_wrap(~draft_era) +
  labs(title = "Weight and Height vs. Draft Pick: NFL-Drafted Defensive Ends", 
       x = "Overall Draft Pick", y = "Weight (lbs)", color = "Height (inches)")
...
nfl_prospects_by_era |>
  ...
  geom_smooth(method = "lm", color = "red") +
  facet_wrap(~draft_era) +
  labs(title = "Weight and Height vs. Draft Pick: NFL-Drafted Defensive Tackles", 
       x = "Overall Draft Pick", y = "Weight (lbs)", color = "Height (inches)")
...
nfl_draft_prospect_data_combined_1985_to_2021 |>
  ...
  labs(title = "Relationship Between Height and Draft Spot: QB Prospects Since 2004", 
       x = "Overall Draft Pick", y = "Height (inches)")
...
nfl_draft_prospect_data_combined_1985_to_2021 |>
  ...
  labs(title = "Distribution of Quarterback Prospect Heights Since 2004, by Year", 
       x = "Draft Year", y = "Height (inches)")
...
nfl_prospects_by_era |>
  ...
  geom_smooth(method = "lm", color = "red") +
  facet_wrap(~draft_era) +
  labs(title = "Height vs. Draft Pick: NFL-Drafted Quarterbacks", 
       x = "Overall Draft Pick", y = "Height (inches)")
...
nfl_prospects_by_era |>
  ...
  geom_smooth(method = "lm", color = "red") +
  facet_wrap(~draft_era) +
  labs(title = "Height vs. ESPN Grade: NFL-Drafted Quarterbacks", 
       x = "ESPN Grade", 
       y = "Height (inches)", 
       subtitle = "A higher ESPN Grade means the quarterback is more highly-touted.")
